...
const Profile = ({ user }) => {
  ...
  return (
    <div className="profile-container">
      <div className="title">
        <h2><i className="fas fa-angle-right"></i>Profile <i className="fas fa-angle-right"></i>{id ? username : "My Profile"}</h2>
      </div>
      {
        loading ? (
          <Loader />
        ...
        <div className="profile-data">
          <AvatarCard id={id} username={id ? username : user.unique_name} onClick={e=>setShow(true)}/>
          <div className="title" style={{zIndex:0}}>
            <h2><i className="fas fa-angle-right"></i>Recent Helps</h2>
          </div>
          <div className="profile-helps">
            {!loading && helps ? helps.map((help,i)=>(
              <div className="helps" key={i}>
                <div className="avatar">
                  <img src="https://pbs.twimg.com/profile_images/1185798852/anonimo2_400x400.jpg"alt={id?username : user.unique_name}/>
